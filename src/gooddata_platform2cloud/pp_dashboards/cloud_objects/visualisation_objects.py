...
from gooddata_platform2cloud.helpers import PP_INSIGHT_PREFIX
...
class VisualisationMaker(BaseModel):
    ...
    def create_visualization(
        ...
        platform_measure_identifier: str = "",
        title: str = "",
        ...
        Args:
            ...
            platform_measure_identifier: Platform metric identifier
        ...
        visualization_object = VisualizationObject(
            attributes=Attributes(
                title=get_migration_id(
                    ...
                    platform_identifier=platform_measure_identifier,
                ),
                content=Content(
