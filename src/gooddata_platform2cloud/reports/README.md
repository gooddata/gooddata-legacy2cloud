...
This directory contains modules for transforming Platform report definitions into Cloud visualization objects.
...
- Context object (`ctx`) is passed to all functions needing access to Platform/Cloud APIs or mappings
