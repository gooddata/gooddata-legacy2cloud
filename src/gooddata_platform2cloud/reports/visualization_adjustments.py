...
from gooddata_platform2cloud.reports.charts.types import is_horizontal_bar_chart
...
class ChartBucketAdjuster:
    ...
    This class provides methods to create and adjust Cloud buckets based on the Platform report format,
    ...
    def adjust_buckets(
        ...
        """
        Create and adjust the Cloud buckets based on the Platform report format.
        ...
        if report_format not in ["line", "chart"]:
            # For grid reports, use the common_buckets passed from transform_platform_report
            ...
            for item in color_items:
                try:
                    ...
                    if uri and uri not in ["metric", "metricGroup"]:
                        ...
                        attr_obj = self.ctx.platform_client.get_object(uri)
