...
"""
Chart processing for Platform to Cloud migration.

This package handles the conversion of Platform chart formatting, styles,
...
from gooddata_platform2cloud.reports.charts.chart_processor import process_chart_report
