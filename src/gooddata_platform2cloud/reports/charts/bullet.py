...
"""
Bullet chart processing for Platform to Cloud migration.

This module handles processing of bullet charts (thermometer in Platform),
...
def process_bullet_chart_mapping(ctx: ContextWithWarnings, chart, content):
    ...
    for mapping in element_mapping:
        ...
        if chart_type and metric_id and chart_type in metric_mappings:
            try:
                ...
                platform_obj = ctx.platform_client.get_object(metric_id)
                if "metric" in platform_obj:
                    platform_metric_identifier = platform_obj["metric"]["meta"][
                        "identifier"
                    ]
                else:
                    platform_metric_identifier = metric_id
                ...
                metric_mappings[chart_type] = {
                    ...
                    "platform_identifier": platform_metric_identifier,
                }
        ...
        if len(comparison_metrics) > 1:
            ...
            for cm in comparison_metrics:
                if cm != chosen_comparison:
                    # Use the Cloud identifier (converted_id) instead of Platform identifier
    ...
    if len(attributes) > 1:
        ...
        for i in range(1, len(attributes)):
            ...
            platform_identifier = attr_uri  # Default to URI
            try:
                ...
                pass
            not_shown_attrs.append(platform_identifier)
    ...
    if attributes:
        ...
        from gooddata_platform2cloud.reports.mappings import map_chart_attribute
