...
from gooddata_platform2cloud.web_compare_processing.parsing.log_parser import LogParser
from gooddata_platform2cloud.web_compare_processing.parsing.metadata import LogMetadata
...
class LogFileMetadataExtractor:
    ...
    def get_connection_params(
        ...
        platform_domain = (
            log_metadata.platform_hostname
            if log_metadata and log_metadata.platform_hostname
            else self.env_vars.platform_domain
        )
        platform_ws = (
            log_metadata.platform_ws
            if log_metadata and log_metadata.platform_ws
            else self.env_vars.platform_ws
        )
        cloud_domain = (
        ...
        return {
            "platform_domain": platform_domain or "",
            "platform_ws": platform_ws or "",
