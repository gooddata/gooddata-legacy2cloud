...
def add_platform_ws_argument(parser: argparse.ArgumentParser) -> None:
    parser.add_argument(
        "--platform-ws",
        dest="platform_ws",
        help="Source Platform workspace ID. Overrides PLATFORM_WS from the .env file if exists.",
        default=None,
    )
...
def add_common_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    add_platform_ws_argument(parser)
...
def add_object_migration_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    - Dump arguments (--dump-platform, --dump-cloud)
    ...
    parser.add_argument(
        ...
        dest="dump_platform",
        default=False,
        help="Dumps Platform objects to a JSON file.",
    )
...
def add_object_filter_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        help="Only migrate objects created by one of the specified Platform user profile IDs "
    ...
    parser.add_argument(
        ...
        help="Only migrate objects NOT created by any of the specified Platform user profile IDs "
        + "(comma-separated, without /gdc/account/profile/ prefix)",
        default=None,
        type=comma_separated_values,
    )
...
def add_validation_element_lookup_with_metrics_argument(
    ...
    parser.add_argument(
        ...
        default=False,
        help="Advanced element lookup using Platform metrics and validation. Automatically "
        + "enables prefetching, then creates temporary Platform metrics containing "
...
def parse_metric_cli_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        dest="ignore_folders",
        default=False,
        help="Platform folders are not migrated to Cloud tags.",
    )
...
def parse_dashboard_permission_cli_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--use-email",
        action="store_true",
        help="Use email field instead of login field when matching Platform users",
    )
    parser.add_argument(
        "--skip-creators",
        action="store_true",
    ...
    parser.add_argument(
        "--print-user-mappings",
        action="store_true",
        help="Print detailed user mapping information for each Platform user",
    )
    args = parser.parse_args()
