...
from gooddata_platform2cloud.insights.cloud_insight import CloudInsight
...
class CloudInsightsBuilder:
    ...
    def __init__(self, ctx: InsightContext):
        ...
        """
        self.platform_insights_raw = None
        self.ctx = ctx
        self.cloud_insights = []

    def process_platform_insights(self, platform_insights_raw: list):
        """
        Load Platform insights and process them to Cloud ones.
        """
        self.platform_insights_raw = platform_insights_raw
        ...
        with ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
            futures = [
                ...
                for index, insight in enumerate(self.platform_insights_raw)
            ]
