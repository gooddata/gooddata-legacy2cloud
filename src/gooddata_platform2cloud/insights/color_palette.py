...
class ColorPalette:
    def __init__(self, ctx: ColorPaletteContext):
        ...
        self.platform_color_palette = self.ctx.platform_client.get_color_palette()
        if not self.platform_color_palette:
            return
    ...
    def transform_color_palette(self):
        ...
        for color in self.platform_color_palette["styleSettings"]["chartPalette"]:
            new_color = {
                "fill": color["fill"],
