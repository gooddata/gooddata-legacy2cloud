...
"""
Utility functions for working with Platform display forms.
...
def get_primary_display_form(
    ...
    shortest identifier (fewest dots). This follows Platform's convention
...
def extract_object_id_from_uri(uri: str) -> str | None:
    """
    Extract the object ID from a Platform URI.

    Args:
        uri: Platform object URI (e.g., "/gdc/md/workspace/obj/12345")
