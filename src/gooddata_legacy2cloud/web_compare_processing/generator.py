...
class ComparisonGenerator:
    ...
    def _prepare_basic_data(
        ...
        return {
            ...
            "legacy_domain": self.result.legacy_domain,
            "legacy_workspace": self.result.legacy_workspace,
    ...
    def _update_result_with_metadata(self, log_metadata) -> None:
        ...
        if log_metadata.legacy_hostname:
            self.result.legacy_domain = log_metadata.legacy_hostname
        if log_metadata.legacy_ws:
            self.result.legacy_workspace = log_metadata.legacy_ws
    ...
    def _format_log_metadata(self, log_metadata) -> Dict:
        ...
        return {
            ...
            "legacy_hostname": log_metadata.legacy_hostname,
            "legacy_ws": log_metadata.legacy_ws,
    ...
    def _prepare_table_rows(self, missing_workspace_info: bool) -> List[Dict]:
        ...
        for item in self.result.items:
            ...
            display_title = (
                item.legacy_title
            )  # Always use Legacy title from the first line of the log
            ...
            row.update(
                {
                    ...
                    "legacy_embedded_url": (
                        item.legacy_embedded_url if item.legacy_embedded_url else ""
                    ),
                    "cloud_embedded_url": (
