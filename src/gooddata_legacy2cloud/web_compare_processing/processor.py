...
from gooddata_legacy2cloud.web_compare_processing.file_utils import JsonDataLoader
from gooddata_legacy2cloud.web_compare_processing.generator import WebCompareUtils
from gooddata_legacy2cloud.web_compare_processing.inheritance import (
    InheritanceManager,
)
...
from gooddata_legacy2cloud.web_compare_processing.path_management import PathManager
    ...
    def process_log_file(
        ...
        try:
            ...
            result = create_comparison_result(
                ...
                legacy_domain=connection_params["legacy_domain"],
                legacy_workspace=connection_params["legacy_ws"],
