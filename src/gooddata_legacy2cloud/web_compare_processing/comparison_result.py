...
class ComparisonItem:
    ...
    Attributes:
        legacy_id: Identifier of the object in Legacy
        legacy_title: Title of the object in Legacy
        legacy_url: URL to the object in Legacy
        ...
        legacy_embedded_url: Optional URL for embedding the Legacy object in an iframe
...
class ComparisonResult:
    ...
    Attributes:
        ...
        legacy_domain: Domain of the Legacy environment
        legacy_workspace: Workspace ID in the Legacy environment
    ...
    def get_ids_by_status(self, status: ComparisonStatus) -> Set[str]:
        """
        Get all Legacy IDs for items with a specific status.
        ...
        Returns:
            Set of Legacy IDs
        """
        return {item.legacy_id for item in self.items if item.status == status}
