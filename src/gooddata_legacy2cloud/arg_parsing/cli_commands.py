...
from gooddata_legacy2cloud.workflows.migrate_dashboards import migrate_dashboards_cli
from gooddata_legacy2cloud.workflows.migrate_insights import migrate_insights_cli
from gooddata_legacy2cloud.workflows.migrate_ldm import migrate_ldm_cli
from gooddata_legacy2cloud.workflows.migrate_metrics import migrate_metrics_cli
from gooddata_legacy2cloud.workflows.migrate_pixel_perfect_dashboards import (
    migrate_pixel_perfect_dashboards_cli,
)
from gooddata_legacy2cloud.workflows.migrate_reports import migrate_reports_cli
...
def main() -> None:
    """Entry point for the gooddata-legacy2cloud CLI."""
