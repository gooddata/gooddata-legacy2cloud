...
class ScheduledMail(Base):
    """Model based on Legacy Scheduled Email API reference.

    Consult docs at [API reference](https://help.gooddata.com/doc/enterprise/en/expand-your-gooddata-legacy/api-reference/#operation/createMetadataObject).
