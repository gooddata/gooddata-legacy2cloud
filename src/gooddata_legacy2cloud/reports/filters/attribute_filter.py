...
"""
Attribute filter class for Legacy to Cloud filter migration.
...
class AttributeFilter(Filter):
    ...
    def get_attribute_identifier(self, attr_uri):
        ...
        try:
            ...
            attr_obj = self.ctx.legacy_client.get_object(attr_uri)
...
class PositiveAttributeFilter(AttributeFilter):
    ...
    def process(self, filter_obj, **kwargs):
        """
        Process a positive attribute filter from Legacy to Cloud format.
...
class NegativeAttributeFilter(AttributeFilter):
    ...
    def process(self, filter_obj, **kwargs):
        """
        Process a negative attribute filter from Legacy to Cloud format.
