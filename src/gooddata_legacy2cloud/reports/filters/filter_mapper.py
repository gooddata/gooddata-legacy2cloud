...
"""
Filter mapping functionality for Legacy to Cloud migration.
...
from gooddata_legacy2cloud.reports.filters.date_helpers import is_date_attribute
...
def map_filter(
    ...
    """
    Maps a Legacy filter to a Cloud filter.
