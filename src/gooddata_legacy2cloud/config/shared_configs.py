...
class WorkspaceConfig(BaseModel):
    ...
    legacy_ws: str | None = Field(
        default=None,
        description="Source Legacy workspace ID. Overrides LEGACY_WS from the .env "
        + "file if exists.",
    )
...
class ObjectMigrationConfig(BaseModel):
    ...
    dump_legacy: bool = Field(
        default=False,
        description="Dumps Legacy objects to a JSON file.",
    )
...
class ObjectFilterConfig(BaseModel):
    ...
    with_creator_profiles: list[str] | None = Field(
        default=None,
        description="Only migrate objects created by one of the specified Legacy user "
        + "profile IDs (/gdc/account/profile/ prefix).",
    )
    without_creator_profiles: list[str] | None = Field(
        default=None,
        description="Only migrate objects NOT created by any of the specified Legacy "
