...
from gooddata_legacy2cloud.arg_parsing.arg_parser import parse_web_compare_cli_args
from gooddata_legacy2cloud.config.configuration_objects import WebCompareConfig
...
from gooddata_legacy2cloud.web_compare_processing import LogProcessor
