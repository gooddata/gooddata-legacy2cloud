...
"""
Top level script for migrating scheduled exports from Legacy to Cloud.
"""
...
from gooddata_legacy2cloud.config.configuration_objects import ScheduledExportConfig
...
LEGACY_SCHEDULED_EXPORTS_FILE = "legacy_scheduled_exports.json"
...
def migrate_scheduled_exports(config: ScheduledExportConfig) -> None:
    ...
    legacy_dump_file = prefix_filename(LEGACY_SCHEDULED_EXPORTS_FILE)
    ...
    command_line_arguments = CommandLineArguments(
        dump_legacy=config.object_migration_config.dump_legacy,
        ...
        legacy_dump_file=legacy_dump_file,
