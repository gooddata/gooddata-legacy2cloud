...
"""
This module is responsible for converting the Legacy MAQL expression
...
from gooddata_legacy2cloud.metrics.maql.content_tree_modifier import (
    ContentTreeModifier,
)
from gooddata_legacy2cloud.metrics.maql.maql_builder import MaqlBuilder


class CloudMaql:
    """
    The CloudMaql class is responsible for converting the Legacy MAQL expression
    into Cloud MAQL expression.
    """

    def __init__(self, ctx: MetricContext, legacy_maql: str, content_tree_legacy: Dict):
        self.ctx = ctx
        self.errors = []
        self.legacy_maql = legacy_maql
        self.content_tree = content_tree_legacy
