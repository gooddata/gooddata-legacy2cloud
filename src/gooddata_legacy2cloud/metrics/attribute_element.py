...
"""
This module is responsible for searching for the attribute element values in Legacy
...
from gooddata_legacy2cloud.metrics.contants import (
...
from gooddata_legacy2cloud.metrics.utils import parse_day_shortcut_to_number
...
class AttributeElement:
    """
    Class searches for the attribute element values in Legacy
    """
    ...
    def _load_object_metadata(self, obj: dict) -> None:
        ...
        if "attributeDisplayForm" in obj:
            ...
            if form_of:
                attribute_obj = self.ctx.legacy_client.get_object(form_of)
    ...
    def _format_cloud_date_value(self, value):
        ...
        be ware there are two date identifiers within Legacy object
        """
    ...
    def _process_element(self):
        ...
        Get the value of the attribute element.
        """
        attr_elems = self.ctx.legacy_client.cache_attribute_elements
        ...
        try:
            output = self.ctx.legacy_client.get_object(self.object_link)
        except Exception:
        ...
        for elements_link, display_form_data in candidates:
            ...
            try:
                elements_output = self.ctx.legacy_client.get_object(endpoint)
            except Exception:
